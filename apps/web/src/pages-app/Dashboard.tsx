...
import { attendanceTone, money, shortDate } from '@/lib/format';
import { useShell } from '@/components/AppShell';
import { PageHeader, PageState } from '@/components/PageHeader';
import { KpiCards, type KpiSpec } from '@/components/primitives';
import { AnnouncementFeed, AttendanceDonut, BarChart, Grid, TodayClasses, UpcomingList } from '@/components/blocks';
