...
import { attendanceTone, shortDate } from '@/lib/format';
...
type ProfileData = {
  ...
  certificates: { title: string; reference: string; issuedOn: string | null; status: string }[];
};

export const Profile = () => {
  const { toast, go, openModal, closeModal } = useShell();
