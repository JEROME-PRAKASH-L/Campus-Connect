...
import { relativeTime, titleCase } from '@/lib/utilities/format';
import { useShell } from '@/components/layout/AppShell';
import { PageHeader, PageState } from '@/components/ui/PageHeader';
import { Chips, KpiCards, Tag } from '@/components/ui/primitives';
import { DataTable, TwoLine } from '@/components/tables/DataTable';
import type { Notification, RouteKey } from '@/types';
...
export const Notifications = () => {
  ...
  const thisWeek = items.filter((n) => now - +new Date(n.createdAt) < 7 * 86_400_000).length;
